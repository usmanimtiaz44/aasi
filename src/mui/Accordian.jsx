  ...
  return (
    <div>
      {/* <div className='' style={{ display: 'flex', alignItems: 'center' }}>
        ...
        <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
            ...
            <Typography className='w-100 '>
                <b>
                IsentCare Healthcare Staffing is Founded
                </b>
                <p className='font14px p-2'>
                IsentCare was established in 1981 when we opened our very first branch office in Seattle, Washington.
                </p>
            </Typography>
            </AccordionSummary>
            <AccordionDetails>
            <Typography className='font14px'>
             IsentCare has branch offices that offer our clients a unique community-based approach with <br />
      ...
      <AccordionSummary
            ...
            <Typography className=' w-100 '>
                <b>
                IsentCare Opens National Operations Center
                </b>
                <p className='font14px p-2'>
            ...
            <AccordionDetails>
            <Typography className='font14px'>
            At IsentCare, we know the lifesaving work of medical professionals doesn’t stop after 5 <br />
      ...
      <AccordionSummary
            ...
            <Typography className=' w-100 '>
                <b>
                IsentCare Expands Lines of Business
                </b>
                <p className='font14px p-2'>
           ...
           <span className='text-primary'>Allied Health & Non-Clinical (2006) – </span>  IsentCare knows that allied health professionals <br />
           ...
           <span className='text-primary'>Managed Services (2006) – </span>  IsentCare provides a comprehensive range of workforce <br />
           ...
           <b>Emergency Response Staffing (2007) – </b>  Our Emergency Response division is <br />
            ...
            IsentCare has been challenged to be more responsive than ever. <br />
      ...
      <AccordionSummary
            ...
            <Typography className=' w-100 '>
                <b>
                IsentCare Launches Volunteer Program
                </b>
                <p className='font14px p-2'>
                IsentCare launched our volunteer program, Volunteering for a Brighter Tomorrow, in 2013
            ...
            <AccordionDetails>
            <Typography className='font14px'>
            IsentCare employees have made an impact across the nation by volunteering at a variety of <br />
      ...
      <AccordionSummary
            ...
            <Typography className=' w-100 '>
                <b>
                IsentCare Makes SIA's Largest Healthcare Staffing Firms List
                </b>
                <p className='font14px p-2'>
                IsentCare has ranked on Staffing Industry Analysts’ List of Largest Healthcare Staffing Firms
            ...
            <AccordionDetails>
            <Typography className='font14px'>
            IsentCare also made the Largest Travel Nurse, Per Diem Nurse and Allied Healthcare Staffing <br />
             Firms lists. For 2021 (based on 2020 revenue), IsentCare was named as <br />
              the: <br />
      ...
      <AccordionSummary
            ...
            <Typography className=' w-100 '>
                <b>
                IsentCareJoins <br /> Acacium Group
                </b>
                <p className='font14px p-2'>
                By bringing the best of their combined staffing experiences across the US, Europe and
                 Australia <br /> IsentCare and Acacium Group will offer a  differentiated, tech-
            ...
            <AccordionDetails>
            <Typography className='font14px'>
            IsentCare was acquired by Acacium Group, Europe’s leading healthcare <br />
             solutions provider. Through this acquisition, IsentCare and Acacium Group become the first <br />
